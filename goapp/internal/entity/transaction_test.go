...
func TestCreateTransaction(t *testing.T) {
	client1, _ := NewClient("Client 1", "c1@c.com")
	account1 := NewAccount(client1)
	client2, _ := NewClient("Client 2", "c2@c.com")
...
func TestCreateTransactionWithInsufientBalance(t *testing.T) {
	client1, _ := NewClient("Client 1", "c1@c.com")
	account1 := NewAccount(client1)
	client2, _ := NewClient("Client 2", "c2@c.com")
	account2 := NewAccount(client2)
	...
	assert.NotNil(t, err)
	assert.Error(t, err, "insuficients funds")
